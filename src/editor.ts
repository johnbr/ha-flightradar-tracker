...
import { DEFAULTS, EDITOR_TYPE, MOTION_MODES, THEME_MODES, type ParsedConfig } from "./config";
...
const SCHEMA = [
  ...
  { name: "title", selector: { text: {} } },
  {
    ...
    schema: [
      ...
      {
        name: "motion",
        selector: { select: { mode: "dropdown", options: [...MOTION_MODES] } },
      },
    ],
  },
  {
